...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251021175556_initial-create")]
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("CK_GymUser_PhoneCheck", "Phone Like '01%' and Phone Not like '%[^0-9]%' ");

                            t.HasCheckConstraint("CK_GymUser_ValidEmailCheck", "Email Like '_%@_%._%'");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("Plans", t =>
                        {
                            t.HasCheckConstraint("CK_Plan_DurationDays_Positive", "DurationDays > 0");

                            t.HasCheckConstraint("CK_Plan_DurationDayse", "DurationDays between 1 and 365");

                            t.HasCheckConstraint("CK_Plan_Price_NonNegative", "Price >= 0");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Session", b =>
                {
                    ...
                    b.ToTable("Sessions", t =>
                        {
                            t.HasCheckConstraint("CK_Session_SessionCapacityCheck", "Capacity Between 1 and 25");

                            t.HasCheckConstraint("CK_Session_StartBeforeEnd", "EndDate > StartDate");
                        });
                });
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("CK_GymUser_PhoneCheck", "Phone Like '01%' and Phone Not like '%[^0-9]%' ")
                                .HasName("CK_GymUser_PhoneCheck1");

                            t.HasCheckConstraint("CK_GymUser_ValidEmailCheck", "Email Like '_%@_%._%'")
                                .HasName("CK_GymUser_ValidEmailCheck1");
                        });
                });
